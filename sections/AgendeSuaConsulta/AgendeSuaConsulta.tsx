...
const DEFAULT_BUTTON_CONTENT = '<a href="#" target="_blank" class="font-display mx-auto my-[25px] text-center w-[25%] block text-[20px] p-[15px] rounded-[8px] bg-gradient-to-r from-[#DBCABE] to-[#A58C7B] shadow-lg text-[#FFFFFF]">AGENDE SUA CONSULTA!</a>';
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        class="home-head-line__contact font-display text-[50px] w-[35%] mx-auto font-[700] text-[#EAEBE6] text-center"
      >
      </div>

      <div 
        dangerouslySetInnerHTML={{ __html: midLine }}
        class="home-mid-line__contact font-display text-[26px] w-[35%] mx-auto font-[500] text-[#E9E9E9] text-center block my-[20px]"
      >
      </div>

      <div 
        dangerouslySetInnerHTML={{ __html: baseLine }}
        class="home-mid-line__contact font-display text-[26px] w-[35%] mx-auto font-[100] text-[#E9E9E9] text-center"
      >
      </div>
